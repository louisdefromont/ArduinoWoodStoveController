...
void handleMotorControl() {
  ...
  html += "<button onclick=\"sendMotorTarget(12.5)\">12.5%</button>";
  html += "<button onclick=\"sendMotorTarget(25.0)\">25.0%</button>";
  html += "</div>";
  html += "<div class='button-container'>";
  html += "<button onclick=\"sendMotorTarget(37.7)\">37.7%</button>";
  html += "<button onclick=\"sendMotorTarget(50.0)\">50.0%</button>";
  html += "<button onclick=\"sendMotorTarget(62.5)\">62.5%</button>";
  html += "</div>";
  html += "<div class='button-container'>";
  html += "<button onclick=\"sendMotorTarget(75.0)\">75.0%</button>";
  html += "<button onclick=\"sendMotorTarget(87.5)\">87.5%</button>";
  html += "<button onclick=\"sendMotorTarget(100.0)\">100.0%</button>";
  html += "</div>";
  html += "<div class='button-container'>";
